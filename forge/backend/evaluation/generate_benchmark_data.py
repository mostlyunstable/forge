...
questions = [
    ...
    {"id": "q2", "question": "How does the ContextRetriever manage the token budget for LLM contexts?"},
    ...
    {"id": "q6", "question": "Where is the logic for incrementally syncing changes to the vector index?"},
    ...
    {"id": "q10", "question": "Where are the application settings and environment variables defined?"},
    ...
    {"id": "q13", "question": "How does the vector store generate deterministic IDs for code points?"},
    {"id": "q14", "question": "Where does the system handle database migrations or schemas?"},
    {"id": "q15", "question": "How are repository graphs updated incrementally when a file is modified?"},
...
ground_truth = {
    ...
    "q3": ["infrastructure/search/graph_adapter.py", "domain/code/repository_contracts/dependency_graph.py"],
    ...
    "q6": ["application/indexing/incremental_index_usecase.py", "application/indexing/reindex_detector.py"],
    "q7": ["domain/indexing/entities/file_index.py", "domain/indexing/repository_contracts/file_index_repository.py"],
    ...
    "q11": ["infrastructure/search/context_retriever.py", "infrastructure/search/lexical_scorer.py"],
    "q12": ["infrastructure/search/lexical_scorer.py"],
    "q13": ["infrastructure/search/qdrant_client.py"],
    "q14": ["infrastructure/database/"], 
    "q15": ["infrastructure/search/graph_adapter.py", "application/indexing/incremental_index_usecase.py", "application/indexing/reindex_detector.py"],
    "q16": ["presentation/routes/"],
    "q17": ["application/indexing/full_index_usecase.py"],
    "q18": ["config/metrics.py", "infrastructure/search/qdrant_client.py", "presentation/routes/metrics.py"],
    "q19": ["application/indexing/full_index_usecase.py", "domain/indexing/services/file_discovery.py"],
    "q20": ["domain/memories/entities/decision.py", "domain/memories/entities/bug.py", "domain/shared/events.py"]
}
