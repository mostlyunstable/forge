...
class MockCandidateRepo:
    async def save_batch(self, *args, **kwargs):
        pass

    async def save_many(self, *args, **kwargs):
        pass
...
class MockMemoryExtractor:
    def extract_from_code_comments(self, *args, **kwargs):
        return []

    def extract_from_commit(self, *args, **kwargs):
        return []

    def extract_from_issue(self, *args, **kwargs):
        return []
...
class MockCommitParser:
    def get_recent_commits(self, *args, **kwargs):
        return []

    def get_file_metadata(self, *args, **kwargs):
        return {}


class MockGitHistoryIngester:
    async def ingest_commit_history(self, *args, **kwargs):
        pass
...
async def run_benchmark():
    ...
    for q in questions:
        ...
        precision = (
            hits_5 / min(len(top_5), len(expected_files)) if top_5 and expected_files else 0.0
        )
