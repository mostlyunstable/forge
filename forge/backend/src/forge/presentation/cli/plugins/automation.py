...
app = typer.Typer(name="automation", help="Maintenance and automation commands.", no_args_is_help=True)
console = Console()
...
def index_cmd():
    ...
    try:
        ...
        console.print("[yellow]IndexingService is not yet available in the application layer. Stub executed.[/yellow]")
        console.print("[bold green]Indexing complete![/bold green]")
